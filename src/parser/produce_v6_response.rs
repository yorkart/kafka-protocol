use super::*;
pub fn produce_v6_response<'i, I>() -> impl Parser<I, Output = ProduceV6Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(responses, throttle_time_ms)| ProduceV6Response {
            responses,
            throttle_time_ms,
        })
}
...
pub struct ProduceV6Response<'i> {
    pub responses: Vec<Responses<'i>>,
    pub throttle_time_ms: i32,
}

impl<'i> crate::Encode for ProduceV6Response<'i> {
