use super::*;
pub fn produce_v7_response<'i, I>() -> impl Parser<I, Output = ProduceV7Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(responses, throttle_time_ms)| ProduceV7Response {
            responses,
            throttle_time_ms,
        })
}
...
pub struct ProduceV7Response<'i> {
    pub responses: Vec<Responses<'i>>,
    pub throttle_time_ms: i32,
}

impl<'i> crate::Encode for ProduceV7Response<'i> {
