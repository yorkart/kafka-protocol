use super::*;
pub fn produce_v4_request<'i, R: RecordBatchParser<I> + 'i, I>(
) -> impl Parser<I, Output = ProduceV4Request<'i, R>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(transactional_id, acks, timeout, topic_data)| ProduceV4Request {
                transactional_id,
                acks,
                timeout,
                topic_data,
...
pub struct ProduceV4Request<'i, R> {
...
impl<'i, R> crate::Encode for ProduceV4Request<'i, R>
where
    R: Encode,
{
