use super::*;
pub fn metadata_v1_response<'i, I>() -> impl Parser<I, Output = MetadataV1Response<'i>> + 'i
where
    ...
    (
        ...
        array(|| {
            (
                ...
                .map(|(error_code, name, is_internal, partitions)| Topics {
                    error_code,
                    name,
                    is_internal,
                    partitions,
        ...
        .map(|(brokers, controller_id, topics)| MetadataV1Response {
            brokers,
            controller_id,
            topics,
        })
...
pub struct MetadataV1Response<'i> {
    pub brokers: Vec<Brokers<'i>>,
    pub controller_id: i32,
    pub topics: Vec<Topics<'i>>,
}

impl<'i> crate::Encode for MetadataV1Response<'i> {
    fn encode_len(&self) -> usize {
        self.brokers.encode_len() + self.controller_id.encode_len() + self.topics.encode_len()
    }
