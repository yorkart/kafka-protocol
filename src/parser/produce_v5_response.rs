use super::*;
pub fn produce_v5_response<'i, I>() -> impl Parser<I, Output = ProduceV5Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(responses, throttle_time_ms)| ProduceV5Response {
            responses,
            throttle_time_ms,
        })
}
...
pub struct ProduceV5Response<'i> {
    pub responses: Vec<Responses<'i>>,
    pub throttle_time_ms: i32,
}

impl<'i> crate::Encode for ProduceV5Response<'i> {
