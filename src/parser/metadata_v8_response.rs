use super::*;
pub fn metadata_v8_response<'i, I>() -> impl Parser<I, Output = MetadataV8Response<'i>> + 'i
where
...
pub struct MetadataV8Response<'i> {
...
impl<'i> crate::Encode for MetadataV8Response<'i> {
