use super::*;
pub fn produce_v6_request<'i, R: RecordBatchParser<I> + 'i, I>(
) -> impl Parser<I, Output = ProduceV6Request<'i, R>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(transactional_id, acks, timeout, topic_data)| ProduceV6Request {
                transactional_id,
                acks,
                timeout,
                topic_data,
...
pub struct ProduceV6Request<'i, R> {
...
impl<'i, R> crate::Encode for ProduceV6Request<'i, R>
where
    R: Encode,
{
