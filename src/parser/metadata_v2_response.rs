use super::*;
pub fn metadata_v2_response<'i, I>() -> impl Parser<I, Output = MetadataV2Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(brokers, cluster_id, controller_id, topics)| MetadataV2Response {
                brokers,
                cluster_id,
                controller_id,
                topics,
...
pub struct MetadataV2Response<'i> {
...
impl<'i> crate::Encode for MetadataV2Response<'i> {
