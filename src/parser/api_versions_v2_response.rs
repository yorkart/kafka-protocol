use super::*;
pub fn api_versions_v2_response<'i, I>() -> impl Parser<I, Output = ApiVersionsV2Response> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(error_code, api_versions, throttle_time_ms)| ApiVersionsV2Response {
                error_code,
                api_versions,
                throttle_time_ms,
            },
...
pub struct ApiVersionsV2Response {
    pub error_code: ErrorCode,
    pub api_versions: Vec<ApiVersions>,
    pub throttle_time_ms: i32,
}

impl crate::Encode for ApiVersionsV2Response {
