use super::*;
pub fn produce_v5_request<'i, R: RecordBatchParser<I> + 'i, I>(
) -> impl Parser<I, Output = ProduceV5Request<'i, R>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(transactional_id, acks, timeout, topic_data)| ProduceV5Request {
                transactional_id,
                acks,
                timeout,
                topic_data,
...
pub struct ProduceV5Request<'i, R> {
...
impl<'i, R> crate::Encode for ProduceV5Request<'i, R>
where
    R: Encode,
{
