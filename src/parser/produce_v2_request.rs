use super::*;
pub fn produce_v2_request<'i, R: RecordBatchParser<I> + 'i, I>(
) -> impl Parser<I, Output = ProduceV2Request<'i, R>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(acks, timeout, topic_data)| ProduceV2Request {
            acks,
            timeout,
            topic_data,
        })
...
pub struct ProduceV2Request<'i, R> {
    pub acks: Acks,
    pub timeout: i32,
    pub topic_data: Vec<TopicData<'i, R>>,
}

impl<'i, R> crate::Encode for ProduceV2Request<'i, R>
where
    R: Encode,
{
