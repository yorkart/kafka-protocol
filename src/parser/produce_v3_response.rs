use super::*;
pub fn produce_v3_response<'i, I>() -> impl Parser<I, Output = ProduceV3Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(responses, throttle_time_ms)| ProduceV3Response {
            responses,
            throttle_time_ms,
        })
}
...
pub struct ProduceV3Response<'i> {
    pub responses: Vec<Responses<'i>>,
    pub throttle_time_ms: i32,
}

impl<'i> crate::Encode for ProduceV3Response<'i> {
