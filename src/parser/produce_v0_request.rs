use super::*;
pub fn produce_v0_request<'i, R: RecordBatchParser<I> + 'i, I>(
) -> impl Parser<I, Output = ProduceV0Request<'i, R>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(acks, timeout, topic_data)| ProduceV0Request {
            acks,
            timeout,
            topic_data,
        })
...
pub struct ProduceV0Request<'i, R> {
    pub acks: Acks,
    pub timeout: i32,
    pub topic_data: Vec<TopicData<'i, R>>,
}

impl<'i, R> crate::Encode for ProduceV0Request<'i, R>
where
    R: Encode,
{
