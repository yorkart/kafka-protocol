use super::*;
pub fn produce_v1_response<'i, I>() -> impl Parser<I, Output = ProduceV1Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(responses, throttle_time_ms)| ProduceV1Response {
            responses,
            throttle_time_ms,
        })
}
...
pub struct ProduceV1Response<'i> {
    pub responses: Vec<Responses<'i>>,
    pub throttle_time_ms: i32,
}

impl<'i> crate::Encode for ProduceV1Response<'i> {
