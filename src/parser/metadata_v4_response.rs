use super::*;
pub fn metadata_v4_response<'i, I>() -> impl Parser<I, Output = MetadataV4Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(throttle_time_ms, brokers, cluster_id, controller_id, topics)| MetadataV4Response {
                throttle_time_ms,
                brokers,
                cluster_id,
                controller_id,
...
pub struct MetadataV4Response<'i> {
...
impl<'i> crate::Encode for MetadataV4Response<'i> {
