use super::*;
pub fn metadata_v5_response<'i, I>() -> impl Parser<I, Output = MetadataV5Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(throttle_time_ms, brokers, cluster_id, controller_id, topics)| MetadataV5Response {
                throttle_time_ms,
                brokers,
                cluster_id,
                controller_id,
...
pub struct MetadataV5Response<'i> {
...
impl<'i> crate::Encode for MetadataV5Response<'i> {
