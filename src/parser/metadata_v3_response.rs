use super::*;
pub fn metadata_v3_response<'i, I>() -> impl Parser<I, Output = MetadataV3Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(throttle_time_ms, brokers, cluster_id, controller_id, topics)| MetadataV3Response {
                throttle_time_ms,
                brokers,
                cluster_id,
                controller_id,
...
pub struct MetadataV3Response<'i> {
...
impl<'i> crate::Encode for MetadataV3Response<'i> {
