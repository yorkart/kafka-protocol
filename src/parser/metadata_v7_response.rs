use super::*;
pub fn metadata_v7_response<'i, I>() -> impl Parser<I, Output = MetadataV7Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(throttle_time_ms, brokers, cluster_id, controller_id, topics)| MetadataV7Response {
                throttle_time_ms,
                brokers,
                cluster_id,
                controller_id,
...
pub struct MetadataV7Response<'i> {
...
impl<'i> crate::Encode for MetadataV7Response<'i> {
