    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
            ...
            (
                ...
                array(|| {
                    (
                        ...
                        be_i64().expected("commit_timestamp"),
        ...
        .map(
            |(group_id, generation_id, member_id, topics)| OffsetCommitRequest {
                group_id,
                generation_id,
                member_id,
                topics,
