use super::*;
pub fn produce_v4_response<'i, I>() -> impl Parser<I, Output = ProduceV4Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(responses, throttle_time_ms)| ProduceV4Response {
            responses,
            throttle_time_ms,
        })
}
...
pub struct ProduceV4Response<'i> {
    pub responses: Vec<Responses<'i>>,
    pub throttle_time_ms: i32,
}

impl<'i> crate::Encode for ProduceV4Response<'i> {
