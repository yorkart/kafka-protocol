use super::*;
pub fn metadata_v4_request<'i, I>() -> impl Parser<I, Output = MetadataV4Request<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(topics, allow_auto_topic_creation)| MetadataV4Request {
            topics,
...
pub struct MetadataV4Request<'i> {
    pub topics: Vec<&'i str>,
    pub allow_auto_topic_creation: bool,
}

impl<'i> crate::Encode for MetadataV4Request<'i> {
