use super::*;
pub fn produce_v3_request<'i, R: RecordBatchParser<I> + 'i, I>(
) -> impl Parser<I, Output = ProduceV3Request<'i, R>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(transactional_id, acks, timeout, topic_data)| ProduceV3Request {
                transactional_id,
                acks,
                timeout,
                topic_data,
...
pub struct ProduceV3Request<'i, R> {
...
impl<'i, R> crate::Encode for ProduceV3Request<'i, R>
where
    R: Encode,
{
