use super::*;
pub fn metadata_v6_response<'i, I>() -> impl Parser<I, Output = MetadataV6Response<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(throttle_time_ms, brokers, cluster_id, controller_id, topics)| MetadataV6Response {
                throttle_time_ms,
                brokers,
                cluster_id,
                controller_id,
...
pub struct MetadataV6Response<'i> {
...
impl<'i> crate::Encode for MetadataV6Response<'i> {
