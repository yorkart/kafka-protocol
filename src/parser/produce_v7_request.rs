use super::*;
pub fn produce_v7_request<'i, R: RecordBatchParser<I> + 'i, I>(
) -> impl Parser<I, Output = ProduceV7Request<'i, R>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(
            |(transactional_id, acks, timeout, topic_data)| ProduceV7Request {
                transactional_id,
                acks,
                timeout,
                topic_data,
...
pub struct ProduceV7Request<'i, R> {
...
impl<'i, R> crate::Encode for ProduceV7Request<'i, R>
where
    R: Encode,
{
