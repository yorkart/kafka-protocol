use super::*;
pub fn produce_v1_request<'i, R: RecordBatchParser<I> + 'i, I>(
) -> impl Parser<I, Output = ProduceV1Request<'i, R>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(acks, timeout, topic_data)| ProduceV1Request {
            acks,
            timeout,
            topic_data,
        })
...
pub struct ProduceV1Request<'i, R> {
    pub acks: Acks,
    pub timeout: i32,
    pub topic_data: Vec<TopicData<'i, R>>,
}

impl<'i, R> crate::Encode for ProduceV1Request<'i, R>
where
    R: Encode,
{
    fn encode_len(&self) -> usize {
        self.acks.encode_len() + self.timeout.encode_len() + self.topic_data.encode_len()
    }
