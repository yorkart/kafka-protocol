use super::*;
pub fn metadata_v6_request<'i, I>() -> impl Parser<I, Output = MetadataV6Request<'i>> + 'i
where
    ...
    I::Error: ParseError<I::Token, I::Range, I::Position>,
{
    (
        ...
        .map(|(topics, allow_auto_topic_creation)| MetadataV6Request {
            topics,
...
pub struct MetadataV6Request<'i> {
    pub topics: Vec<&'i str>,
    pub allow_auto_topic_creation: bool,
}

impl<'i> crate::Encode for MetadataV6Request<'i> {
